...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/domain/Address.java#L3-L30[Address.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/domain/Countries.java#L3-L19[Countries.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/domain/UnitedStates.java#L3-L70[UnitedStates.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/domain/CreditCard.java#L5-L26[CreditCard.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/domain/CreditCardType.java##L3-L20[CreditCardType.java]
----
...
Since each one of them has a long text name, we can also encapsulate them into an enum link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/domain/MailingOption.java#L6-L47[MailingOption.java]
...
We already have `OtherInformation` in Listing 14.20 link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch14elements/domain/OtherInformation.java[OtherInformation.java]. Since we added this enum for mailing option, we need to change the type for variable `mailingOption` from `String` to `MailingOption` in `OtherInformation` class.

[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/domain/OtherInformation.java[OtherInformation.java]
----
...
[[xpath-enum]]
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/locators/ClassName.java#L9-L30[ClassName.java]
----
...
[[BookstoreHomepage]]
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/pages/BookstoreHomepage.java#L10-L27[BookstoreHomepage.java]
----
...
[[BookStoreShoppingIT]]
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/tests/BookstoreSearchIT.java#L11-L23[BookstoreSearchIT.java]
----
@Test
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/pages/BookListPage.java#L10-L27[BookListPage.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/pages/BookPage.java#L9-L29[BookPage.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/pages/CreditCardForm.java#L10-L24[CreditCardForm.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/pages/BillingAddressForm.java#L10-L29[BillingAddressForm.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/pages/OtherInformationForm.java#L9-L25[OtherInformationForm.java]
----
...
[[ShoppingCartPage]]
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/pages/ShoppingCartPage.java#L12-L45[ShoppingCartPage.java]
----
...
[[ConfirmationPage]]
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/pages/ConfirmationPage.java#L12-L45[ConfirmationPage.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/tests/BookstoreShoppingIT.java#L24-L26[BookstoreShoppingIT.java]
----
...
And some variables for the data to be used to fill out the forms in link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/tests/BookstoreShoppingIT.java#L31-L61[BookstoreShoppingIT.java]
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/tests/BookstoreShoppingIT.java#L63-L82[BookstoreShoppingIT.java]
----
@Before   <6>
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch15pageflow/tests/BookstoreShoppingIT.java#L84-L93[BookstoreShoppingIT.java]
----
@Test
public void purchaseSuccessful() {
    new ShoppingCartPage(browser) {{    <3>
        setBillingAddress(billingAddress);
        setOtherInformation(otherInformation);
        setCreditCard(creditCard);    //<1>
        confirm();
    }};
    new ConfirmationPage(browser) {{   <4>

= Unicorns and other beasts: Exotic features of web pages
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch09unicorns/actionchains/ExampleIT.java[ExampleIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch09unicorns/actionchains/CopyAndPasteIT.java[CopyAndPasteIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch09unicorns/actionchains/MouseHoverIT.java[MouseHoverIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch09unicorns/draganddrop/DragAndDropIT.java[DragAndDropIT.java]
----------------------------------------------
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch09unicorns/actionchains/LazyActionChainIT.java[LazyActionChainIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch09unicorns/actionchains/LazyElement.java[LazyElement.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch09unicorns/select/MultipleSelectIT.java[MultipleSelectIT.java]
------------------------------------------------------------------
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch09unicorns/select/MulipleSelectIT.java[MulipleSelectIT.java]
----------------------------------------------------------------------
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch09unicorns/fileupload/FileUploadIT.java[FileUploadIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch09unicorns/tooltips/Tooltip.java[Tooltip.java]
----

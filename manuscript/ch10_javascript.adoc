= Executing JavaScript using the `JavascriptExecutor` interface
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch10javascript/usage/JavascriptExecutorUsageIT.java[JavascriptExecutorUsageIT.java]
----
...
=== Technique 27: Using JavaScript to verify that an image is loaded
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch10javascript/images/VerifyingImagesIT.java[VerifyingImagesIT.java]
----
@Before
...
[source,html]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/main/webapp/print-the-time.html[print-the-time.html]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch10javascript/time/PrintTheTimeIT.java[PrintTheTimeIT.java]
----
        ((JavascriptExecutor) driver).executeScript(
...
[source,html]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/main/webapp/geolocation.html[geolocation.html]
----
...
=== Technique 28: Overriding JavaScript to control geolocation
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch10javascript/geolocationjs/GeolocationIT.java[GeolocationIT.java]
----
@Test
...
=== Technique 29: Overriding JavaScript to capture a notification
...
[source,javascript]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch10javascript/webnotification/Notification.java[Notification.java]
----
...
[source,java]
.https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch10javascript/webnotification/WebNotificationIT.java[WebNotificationIT.java]
----
JavascriptExecutor jsExecutor = (JavascriptExecutor) driver;

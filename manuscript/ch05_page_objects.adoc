...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/LoginForm.java[LoginForm.java]
----
    public class LoginForm {
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/fluentbuilder/LoginFormIT.java[fluentbuilder/LoginFormIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/fluentbuilder/LoginForm.java[fluentbuilder/LoginForm.java]
----
    public class LoginForm {
        private final WebElement loginForm;
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/a/SearchForm.java[a/SearchForm.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/a/SearchFormIT.java[a/SearchFormIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/c/SearchPage.java[c/SearchPage.java]
----
    public class SearchPage {
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/d/SearchPage.java[d/SearchPage.java]
----
    public SearchPage(WebDriver driver) {
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/pagefactory/whybad/SearchForm.java[pagefactory/whybad/SearchForm.java]
----
    public class SearchForm {
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/pagefactory/SearchForm.java[pagefactory/SearchForm.java]
----
public class SearchForm {
    @FindBy(name = "q")
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/pagefactory/SearchFormIT.java[pagefactory/SearchFormIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/loadable/SearchForm.java[loadable/SearchForm.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/loadable/SearchFormIT.java[loadable/SearchFormIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/loadablepagefactory/SearchForm.java[loadablepagefactory/SearchForm.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/loadablepagefactory/SearchFormIT.java[loadablepagefactory/SearchFormIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/loadablepagefactory/LoadingPageFactory.java[LoadingPageFactory.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/loadablepagefactory/Path.java[Path.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch05pageobjects/loadablepagefactory/Verify.java[Verify.java]
----

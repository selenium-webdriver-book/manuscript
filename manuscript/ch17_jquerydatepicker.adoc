...
.Elements, locators and enums for jQuery datepicker
...
Now that we all the locators, we can apply the technique we learnt from Expose locator enums as a `Supplier<By>` interface. Now we create two enum constants.

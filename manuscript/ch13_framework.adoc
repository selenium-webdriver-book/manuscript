...
[[error-prone]]
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/tests/ErrorProneLocatingLogicIT.java#L40-L51[ErrorProneLocatingLogicIT.java]
----
...
[[explicit-waits1]]
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/tests/LocatingLogicWithExplicitWaitIT.java#L29-L41[LocatingLogicWithExplicitWaitIT.java]
----
...
[[explicit-waits2]]
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/tests/LocatingLogicWithExplicitWaitIT.java#L43-L68[LocatingLogicWithExplicitWaitIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v1/ExplicitWait.java#L13-L24[ExplicitWait.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v1/Browser.java#L6-L12[Browser.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v1/Element.java#L6-25[Element.java]
----
...
[[explicit-test]]
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/tests/ExplicitWait_v1_IT.java#L28-L35[ExplicitWait_v1_IT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v1_0_prejava8/ExplicitWait.java#L6-L9[ExplicitWait.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v1_0_prejava8/Browser.java#L13-L32[Browser.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v1_5/ExplicitWait.java#L11-22[ExplicitWait.java]
----
public interface ExplicitWait {
...
[[optional-element]]
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v2/SearchScope.java#L8-L19[SearchScope.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v1_5_prejava8/SearchScope.java#L3-L11[SearchScope.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/tests/ExplicitWait_v2_IT.java#L29-L37[ExplicitWait_v2_TT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v3/DelegatingWebDriver.java#L12-L122[DelegatingWebDriver.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v3/Browser.java#L5-L116[Browser.java]
----
public class Browser extends DelegatingWebDriver {
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/tests/SearchPage_v2_IT.java#L12-L27[SearchPage_v2_IT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v3/DelegatingWebElement.java#L8-L105[DelegatingWebElement.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v3/Element.java#L5-L16[Element.java]
----
...
Let is use `LoginForm` class in Listing 5.2 link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch05pageobjects/LoginForm.java[LoginForm.java] from Chapter 5, and create new test using `Browser` and `Element` and this old `LoginForm`,

[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/tests/LoginForm_v2_IT.java#L26-L35[LoginForm_v2_IT.java]
----
@Test
...
[[repeated-method]]
[source,java]
.Methods in both link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v3/DelegatingWebDriver.java#L49-L57[DelegatingWebDriver.java] and link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v3/DelegatingWebElement.java#L15-L23[DelegatingWebElement.java]
----
@Override
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v4/DelegatingSearchContext.java#L10-L33[DelegatingSearchContext.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v4/DelegatingWebDriver.java#L11-L108[DelegatingWebDriver.java]
----
public class DelegatingWebDriver
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch13framework/v4/DelegatingWebElement.java#L8-L99[DelegatingWebElement.java]
----

...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch02locatingelements/InputBy.java[InputBy.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch02locatingelements/ElementBy.java[ElementBy.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch02locatingelements/TableIT.java[TableIT.java]
----
	int columnNumber = 1;
        while (!driver
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch02locatingelements/TdBy.java[TdBy.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch02locatingelements/ChainedLocatorsIT.java[ChainedLocatorsIT.java]
----
driver
...
[[by-chained]]
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch02locatingelements/LocatorCompositionIT.java[LocatorCompositionIT.java]
----
driver.findElement(
        new ByChained(
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch02locatingelements/AllBy.java[AllBy.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch02locatingelements/AnyBy.java[AnyBy.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch02locatingelements/NotBy.java[NotBy.java]
----

...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch08windows/windows/NewWindowIT.java[NewWindowIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch08windows/windows/WindowHandlerIT.java[WindowHandlerIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch08windows/windows/WindowHandler.java[WindowHandler.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch08windows/modals/JavaScriptAlertIT.java[JavaScriptAlertIT.java]
------------------------------------------------------------------------
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch08windows/modals/HttpAuthenticationIT.java[HttpAuthenticationIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch08windows/modals/Modals.java[Modals.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch08windows/modals/BootstrapModal.java[BootstrapModal.java]
----

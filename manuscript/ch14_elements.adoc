...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/tests/RegistrationForm_v2_IT.java#L23-L37[RegistrationForm_v2_IT.java]
----
...
[[NaiveRadioIT]]
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/tests/NaiveRadioIT.java#L29-L42[NaiveRadioIT.java]
----
@Test
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/v4_5/Browser.java#L14-18[Browser.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/tests/RegistrationForm_v4_IT.java#L22-L23[RegistrationForm_v4_IT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/v5/Browser.java#L53-L55[Browser.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/v5/Browser.java#L83-L94[Browser.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/tests/RadioIT.java#L25-L28[RadioIT.java]
----
@Test
...
[[set-radio]]
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/v5/Browser.java#L68-L81[Browser.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/v5/Browser.java#L57-L62[Browser.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/v5/Browser.java#L64-L66[Browser.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/v5/Browser.java#L96-L121[Browser.java]
----
...
****
If you use Java 8, you can use lambda expression in above code, as in link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/v4_6/Browser.java#L108-L115[Browser.java]
...
Besides normal form elements, we can also encapsulate mouse action into `Browser`. Let us revisit Listing 3.11 link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch03interacting/MouseInputIT.java#L30-34[MouseInputIT.java]
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/v5/Browser.java#L127-L130[Browser.java]
----
...
And then Listing 3.11 link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch03interacting/MouseInputIT.java[MouseInputIT.java] can be rewritten as following, which is cleaner and concise.

[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/tests/MouseInputIT.java#L22[MouseInputIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/tests/RegistrationForm_v4_IT.java#L22-L29[RegistrationForm_v4_IT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/framework/robust/Attemptable.java#L3-L5[Attemptable.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/framework/robust/Retry.java#L5-L33[Retry.java]
----
public class Retry {
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/v5/Browser.java#L24-L38[Browser.java]
----
...
.Replace anonymous inner class with Lambda Expression
****
If you use Java 8, you don't need anonymous inner classes in your code, here is part of the example written using lambda expression, link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/v5/Browser.java#L40-L51[Browser.java]
...
[[billing-information]]
image::billing-information.png[title=Billing Information Form]
...
.Replace anonymous inner class with Lambda Expression
****
If you use Java 8, you can rewrite the for loop using Stream API, it is not necessarily cleaner than before, link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/domain/MailingOption.java#L38-L46[MailingOption.java]
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/pages/NaiveShoppingCartPage.java#L6-L53[NaiveShoppingCartPage.java]
----
...
[[longer_test]]
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/tests/NaiveShoppingCartPageIT.java#L34-L47[NaiveShoppingCartPageIT.java]
----
@Test
...
[[OtherInformation]]
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/domain/OtherInformation.java#L8-L44[OtherInformation.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/pages/OtherInformationForm.java#L29-L39[OtherInformationForm.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/pages/ShoppingCartPage.java#L6-L21[ShoppingCartPage.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/tests/ShoppingCartPageIT.java#L44-L48[ShoppingCartPageIT.java]
----
@Test

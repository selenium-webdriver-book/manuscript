...
[[longer_test]]
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch14elements/tests/NaiveShoppingCartPageIT.java#L#L34-L47[NaiveShoppingCartPageIT.java]
----
@Test

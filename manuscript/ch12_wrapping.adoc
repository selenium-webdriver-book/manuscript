...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch12wrapping/tests/ScreenshotIT.java[ScreenshotIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch12wrapping/v0_5/DelegatingWebDriver.java[DelegatingWebDriver.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/framework/BaseUrlDriver.java[BaseUrlDriver.java]
----
...
[[DelegatingWebDriver]]
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch12wrapping/v0_8/DelegatingWebDriver.java[DelegatingWebDriver.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/framework/WebDriverConfig.java[WebDriverConfig.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/framework/HttpStatusCodeSupplier.java[HttpStatusCodeSupplier.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch12wrapping/tests/HttpStatusCodeIT.java[HttpStatusCodeIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch12wrapping/table/Table.java[Table.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch12wrapping/table/SimpleTable.java[SimpleTable.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch12wrapping/tests/TableIT.java[TableIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch12wrapping/table/ColumnNumberFinder.java[ColumnNumberFinder.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch12wrapping/v0_7/ShoppingCartBySupplier.java[ShoppingCartBySupplier.java]
----
...
[[call_get]]
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch12wrapping/tests/ShoppingCartBySupplierIT.java[ShoppingCartBySupplierIT.java]
----
...
[[ByName]]
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch12wrapping/v0_8/Name.java[Name.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/framework/DelegatingSearchContext.java#L29-L32[DelegatingSearchContext.java]
----
@Override

...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch06problems/CommonExceptionsIT.java[CommonExceptionsIT.java]
----
    @Before
...
=== Technique 17: Retrying on exception
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch06problems/TransparentRetryIT.java[TransparentRetryIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch06problems/ImplicitWaitIT.java[ImplicitWaitIT.java]
----
...
=== Technique 18: Using WebDriverWait to wait for slippery elements
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch06problems/ExplicitWaitIT.java[ExplicitWaitIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch06problems/ExplicitFluentWaitIT.java[ExplicitFluentWaitIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch06problems/FindByClassNameIT.java[FindByClassNameIT.java]
----
@Test(expected = NoSuchElementException.class)
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch06problems/FindByTagNameIT.java[FindByTagNameIT.java]
----
@Test
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch06problems/FindByXpathIT.java[FindByXpathIT.java]
----
@Test
public void locateSuccessfully() {
    driver.findElement(
...
=== Technique 19: Extracting link text to resource bundles for internationalization
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch06problems/ResourceBundleExampleIT.java[ResourceBundleExampleIT.java]
----

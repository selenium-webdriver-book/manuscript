...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch06problems/CommonExceptionsIT.java[CommonExceptionsIT.java]
----
    @Before
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch06problems/TransparentRetryIT.java[TransparentRetryIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch06problems/ImplicitWaitIT.java[ImplicitWaitIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch06problems/ExplicitWaitIT.java[ExplicitWaitIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch06problems/ExplicitFluentWaitIT.java[ExplicitFluentWaitIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch06problems/FindByClassNameIT.java[FindByClassNameIT.java]
----
@Test(expected = NoSuchElementException.class)
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch06problems/FindByTagNameIT.java[FindByTagNameIT.java]
----
@Test
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch06problems/FindByXpathIT.java[FindByXpathIT.java]
----
@Test
public void locateSuccessfully() {
    driver.findElement(
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swip/ch06problems/ResourceBundleExampleIT.java[ResourceBundleExampleIT.java]
----

...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch04examiningapage/ElementIsPresentIT.java[ElementIsPresentIT.java]
----
@Test
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch04examiningapage/ElementIsVisibleIT.java[ElementIsVisibleIT.java]
----
    @Test
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch04examiningapage/PageTitleIT.java[PageTitleIT.java]
----
    @Test
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch04examiningapage/VerifyingTextIT.java[VerifyingTextIT.java]
----
    @Test
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch04examiningapage/VerifyingStylesIT.java[VerifyingStylesIT.java]
----
    @Test
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch04examiningapage/CssShorthandIT.java[CssShorthandIT.java]
----
    @Test
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swb/ch04examiningapage/VerifyingFormIT.java[VerifyingFormIT.java]
----

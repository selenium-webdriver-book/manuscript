...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch11drivers/WebDriverBinarySupplier.java#L6-L12[WebDriverBinarySupplier.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch11drivers/ChromeDriverBinarySupplier.java#L26-L34[ChromeDriverBinarySupplier.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch11drivers/ChromeDriverBinarySupplier.java#L36-L48[ChromeDriverBinarySupplier.java]
----
@Override
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch11drivers/ChromeDriverBinarySupplier.java#L50-L110[ChromeDriverBinarySupplier.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch11drivers/mobileemulation/ChromeMobileEmulationKnownDeviceIT.java#L28-L37[ChromeMobileEmulationKnownDeviceIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch11drivers/mobileemulation/ChromeMobileEmulationDeviceAttributesIT.java#L26-L45[ChromeMobileEmulationDeviceAttributesIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch11drivers/VagrantInternetExplorerIT.java#L16-L33[VagrantInternetExplorerIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch11drivers/AppiumIPhoneIT.java#L20-L51[AppiumIPhoneIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-book/source/blob/master/src/test/java/swb/ch11drivers/AppiumAndroidIT.java#L26-L29[AppiumAndroid.java]
----
...
A couple of notes on Appium. First, it only supports a subset of locators: XPath and class name. Also, some methods, such as swbe and pinch, are not currently supported. But it is rapidly improving, so by the time you read this, this might have changed!

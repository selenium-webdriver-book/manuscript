...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch03interacting/LoginIT.java[LoginIT.java]
----
@Test
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch03interacting/KeyboardInputIT.java[KeyboardInputIT.java]
----
    driver.get("http://localhost:8080/form.html");
    driver
            .findElement(By.name("email")) <1>
            .sendKeys("john.doe@swip.com"); <2>
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch03interacting/WyswygInputIT.java[WyswygInputIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch03interacting/MouseInputIT.java[MouseInputIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch03interacting/ContextMenuIT.java[ContextMenuIT.java]
----
...
[source,java]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/test/java/swip/ch03interacting/FormIT.java[FormIT.java]
----
...
[source,html]
.link:https://github.com/selenium-webdriver-in-practice/source/blob/master/src/main/webapp/registration-form.html[registration-form.html]
----
